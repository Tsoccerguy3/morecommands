	...
	public static class EntitySelector {
		...
		private static void getRotationsPredicates(ListMultimap<String, String> argumentMap, ImmutableList.Builder<Predicate<Entity>> predicateBuilder) {
	        if (argumentMap.containsKey(ARGUMENT_ROTY_MIN) || argumentMap.containsKey(ARGUMENT_ROTY_MAX)) {
	        	final int yawMin = MathHelper.wrapDegrees(getInt(argumentMap, ARGUMENT_ROTY_MIN, 0));
	        	final int yawMax = MathHelper.wrapDegrees(getInt(argumentMap, ARGUMENT_ROTY_MAX, 359));
	        	
	        	predicateBuilder.add(new Predicate<Entity>() {
	                @Override
	                public boolean apply(Entity entity) {
	                	int yaw = MathHelper.wrapDegrees(MathHelper.floor(entity.rotationYaw));
	        ...
	        if (argumentMap.containsKey(ARGUMENT_ROTX_MIN) || argumentMap.containsKey(ARGUMENT_ROTX_MAX)) {
	        	final int pitchMin = MathHelper.wrapDegrees(getInt(argumentMap, ARGUMENT_ROTX_MIN, 0));
	        	final int pitchMax = MathHelper.wrapDegrees(getInt(argumentMap, ARGUMENT_ROTX_MAX, 359));
	        	
	        	predicateBuilder.add(new Predicate<Entity>() {
	        		@Override
	        		public boolean apply(Entity entity) {
	        			int pitch = MathHelper.wrapDegrees(MathHelper.floor(entity.rotationPitch));
