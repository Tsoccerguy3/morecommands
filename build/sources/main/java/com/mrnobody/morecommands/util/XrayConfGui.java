...
public class XrayConfGui extends GuiScreen {
	...
	public class GuiList extends GuiSlot {
		...
		protected void drawSlot(int index, int left, int top, int slotHeight, int mouseX, int mouseY, float partialTicks) {
			...
			if (blockItem != null) {
				...
				//XrayConfGui.this.mc.getRenderItem().renderItemOverlayIntoGUI(this.fontRenderer, new ItemStack(blockItem), left, top, blockItem.getUnlocalizedName());
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRenderer, this.heading, this.width / 2, 10, 0xFFFFFF);
		super.drawScreen(mouseX, mouseY, partialTicks);
	}
